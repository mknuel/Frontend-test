...
const RecommendationLoader: React.FC = () => {
	return (
		<div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl flex flex-col w-full relative animate-pulse">
						...
						<div className="mt-auto p-4 pb-0 bg-gray-100 dark:bg-gray-700 h-full rounded-md space-y-3">
							...
							<div className="flex justify-center gap-2 pt-2">
								{Array.from({ length: 4 }).map((_, i) => (
									<div
										key={i}
										className="w-2.5 h-2.5 bg-gray-300 dark:bg-gray-600 rounded-sm"
									/>
								))}
							</div>
						</div>
